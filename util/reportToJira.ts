...
const command = `curl -H "Content-Type: text/xml" -X POST -H "Authorization: Bearer ${token}" --data @"output/playwright-report/xray-report.xml" "${baseUrl}/api/v2/import/execution/junit?projectKey=SCRUM&testPlanKey=SCRUM-33"`;
